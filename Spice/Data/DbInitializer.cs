...
namespace Spice.Data
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public async void Initialize()
        {
            ...
            {
                UserName = "httpsdangtuanhuyhachi@gmail.com",
                Email = "httpsdangtuanhuyhachi@gmail.com",
                Name = "Dang Tuan Huy",
                EmailConfirmed = true,
                PhoneNumber = "0963505927"
            }, "Admin123*").GetAwaiter().GetResult();

            IdentityUser user = await _db.Users.FirstOrDefaultAsync(u => u.Email == "httpsdangtuanhuyhachi@gmail.com");
